...
namespace YoungFit.PL
{
    public partial class AdminForm : Form
    {
        ...
        Repository<Yemek> yemekRepo = new Repository<Yemek>();
        ...
        private void btnBesinDuzenle_Click(object sender, EventArgs e)
        {
            ...
            //seciliBesin.Resim = File.ReadAllBytes(pbSecilenYemek.ImageLocation);
            yemekRepo.Guncelle();

            MessageBox.Show("Seçilen Besin Güncellendi");
            BesinleriGetir();

            // düzenlenen besini dgv ' de seçili hale getirme
            //int seciliSatir = dgvBesinler.SelectedCells[0].RowIndex;
            //dgvBesinler.Rows[seciliSatir].Selected = true;
            //pbSecilenYemek.Image = seciliYemek.Resim == null ? null : Image.FromStream(new MemoryStream(seciliYemek.Resim));
        ...
        private void btnBesinSil_Click(object sender, EventArgs e)
        {
            ...
            {
                db.Yemekler.Remove(silinecekYemek);
                db.SaveChanges();
